...
object AnIndexedLensRules extends Laws {
  def apply[S: Arbitrary: Eq, A: Arbitrary: Eq, I: Arbitrary: Eq](lens: AnIndexedLens[I, S, A])(implicit ev: Arbitrary[(I, A) => A]): RuleSet = {
    val laws = AnIndexedLensLaws(lens)
