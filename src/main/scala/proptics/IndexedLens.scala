...
object IndexedLens {
  private[proptics] def apply[P[_, _], I, S, T, A, B](f: P[(I, A), B] => P[S, T])(implicit ev: Strong[P]): IndexedLens[P, I, S, T, A, B] =
  ...
  private[proptics] def ilens[P[_, _], I, S, T, A, B](get: S => (I, A))(set: S => B => T)(implicit ev: Strong[P]): IndexedLens[P, I, S, T, A, B] =
    ilens_((get, set).mapN(Tuple2.apply))

  private[proptics] def ilens_[P[_, _], I, S, T, A, B](to: S => ((I, A), B => T))(implicit ev: Strong[P]): IndexedLens[P, I, S, T, A, B] =
