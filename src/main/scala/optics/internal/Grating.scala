...
abstract class GratingInstances {
  implicit def profunctorGrating[E, F]: Profunctor[Grating[E, F, *, *]] = new Profunctor[Grating[E, F, *, *]] {
  ...
  implicit def closedGrating[E, F]: Closed[Grating[E, F, *, *]] = new Closed[Grating[E, F, *, *]] {
