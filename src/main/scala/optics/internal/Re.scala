...
abstract class ReInstances {
  ...
  implicit def choiceRe[P[_, _], S, T](implicit ev: Choice[P]): Cochoice[Re[P, S, T, *, *]] = new Cochoice[Re[P, S, T, *, *]] {
  ...
  implicit def cochoiceRe[P[_, _], S, T](implicit ev: Cochoice[P]): Choice[Re[P, S, T, *, *]] = new Choice[Re[P, S, T, *, *]] {
    override def left[A, B, C](pab: Re[P, S, T, A, B]): Re[P, S, T, Either[A, C], Either[B, C]] =
      Re(pab.runRe compose ev.unleft)

    override def right[A, B, C](pab: Re[P, S, T, B, C]): Re[P, S, T, Either[A, B], Either[A, C]] =
  ...
  implicit def strongRe[P[_, _], S, T](implicit ev: Strong[P]): Costrong[Re[P, S, T, *, *]] = new Costrong[Re[P, S, T, *, *]] {
  ...
  implicit def costrongRe[P[_, _], S, T](implicit ev: Costrong[P]): Strong[Re[P, S, T, *, *]] = new Strong[Re[P, S, T, *, *]] {
