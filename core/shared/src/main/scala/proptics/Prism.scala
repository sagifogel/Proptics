...
abstract class Prism_[S, T, A, B] extends Serializable { self =>
  ...
  /** compose this [[Prism_]] with a function lifted to a [[Getter_]], having this [[Prism_]] applied last */
  ...
  final def andThen[C, D](other: Iso_[C, D, S, T]): Prism_[C, D, A, B] = new Prism_[C, D, A, B] {
  ...
  final def compose[C, D](other: AnIso_[A, B, C, D]): Prism_[S, T, C, D] =
  ...
  final def andThen[C, D](other: AnIso_[C, D, S, T]): Prism_[C, D, A, B] =
  ...
  final def andThen[C, D](other: Lens_[C, D, S, T]): AffineTraversal_[C, D, A, B] = new AffineTraversal_[C, D, A, B] {
  ...
  final def compose[C, D](other: ALens_[A, B, C, D]): AffineTraversal_[S, T, C, D] =
    AffineTraversal_[S, T, C, D](s => self.viewOrModify(s).map(other.view))(s => d => self.over(a => other.set(d)(a))(s))
  ...
  final def andThen[C, D](other: ALens_[C, D, S, T]): AffineTraversal_[C, D, A, B] =
    AffineTraversal_[C, D, A, B](c => self.viewOrModify(other.view(c)).leftMap(other.set(_)(c)))(c => b => other.over(a => self.set(b)(a))(c))
