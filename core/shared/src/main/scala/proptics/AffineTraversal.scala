...
abstract class AffineTraversal_[S, T, A, B] extends Serializable { self =>
  ...
  /** compose this [[AffineTraversal_]] with a function lifted to a [[Getter_]], having this [[AffineTraversal_]] applied last */
  ...
  final def andThen[C, D](other: Iso_[C, D, S, T]): AffineTraversal_[C, D, A, B] = new AffineTraversal_[C, D, A, B] {
  ...
  final def compose[C, D](other: AnIso_[A, B, C, D]): AffineTraversal_[S, T, C, D] = new AffineTraversal_[S, T, C, D] {
  ...
  final def andThen[C, D](other: AnIso_[C, D, S, T]): AffineTraversal_[C, D, A, B] = new AffineTraversal_[C, D, A, B] {
  ...
  final def andThen[C, D](other: AnAffineTraversal_[C, D, S, T]): AffineTraversal_[C, D, A, B] =
    AffineTraversal_ { c: C => other.viewOrModify(c).flatMap(self.viewOrModify(_).leftMap(other.set(_)(c))) } { c => b =>
