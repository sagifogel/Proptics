...
abstract class GratingInstances {
  implicit final def profunctorGrating[E, F]: Profunctor[Grating[E, F, *, *]] = new Profunctor[Grating[E, F, *, *]] {
  ...
  implicit final def closedGrating[E, F]: Closed[Grating[E, F, *, *]] = new Closed[Grating[E, F, *, *]] {
    override def closed[A, B, C](pab: Grating[E, F, A, B]): Grating[E, F, C => A, C => B] =
      Grating(c2a2e2f => c => pab.runGrating(a2e => c2a2e2f(c2a => a2e(c2a(c)))))
