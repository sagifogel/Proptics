...
abstract class Traversal_[S, T, A, B] extends Serializable { self =>
  ...
  /** compose [[Traversal_]] with an [[Lens_]] */
  ...
  /** compose [[Traversal_]] with an [[Prism_]] */
  ...
  /** compose [[Traversal_]] with an [[Traversal_]] */
