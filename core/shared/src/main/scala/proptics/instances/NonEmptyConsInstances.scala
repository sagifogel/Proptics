...
trait NonEmptyConsInstances {
  ...
  implicit def nonEmptyConsTuple3[A, B, C]: NonEmptyCons[(A, B, C), A, (B, C)] = new NonEmptyCons[(A, B, C), A, (B, C)] {
    override def nonEmptyCons: Iso[(A, B, C), (A, (B, C))] =
      Iso.iso[(A, B, C), (A, (B, C))](t => (t._1, (t._2, t._3))) { case (h, t) => (h, t._1, t._2) }
  }

  implicit def nonEmptyConsTuple4[A, B, C, D]: NonEmptyCons[(A, B, C, D), A, (B, C, D)] = new NonEmptyCons[(A, B, C, D), A, (B, C, D)] {
    override def nonEmptyCons: Iso[(A, B, C, D), (A, (B, C, D))] =
      Iso.iso[(A, B, C, D), (A, (B, C, D))](t => (t._1, (t._2, t._3, t._4))) { case (h, t) => (h, t._1, t._2, t._3) }
  }

  implicit def nonEmptyConsTuple5[A, B, C, D, E]: NonEmptyCons[(A, B, C, D, E), A, (B, C, D, E)] = new NonEmptyCons[(A, B, C, D, E), A, (B, C, D, E)] {
  ...
  implicit def nonEmptyConsNonEmptyVector[A]: NonEmptyCons[NonEmptyVector[A], A, Vector[A]] = new NonEmptyCons[NonEmptyVector[A], A, Vector[A]] {
  ...
  implicit def nonEmptyConsNoneEmptyList[A]: NonEmptyCons[NonEmptyList[A], A, List[A]] = new NonEmptyCons[NonEmptyList[A], A, List[A]] {
  ...
  implicit def nonEmptyConsNonEmptyChain[A]: NonEmptyCons[NonEmptyChain[A], A, Chain[A]] = new NonEmptyCons[NonEmptyChain[A], A, Chain[A]] {
  ...
  implicit def nonEmptyConsOneAnd[F[_], A]: NonEmptyCons[OneAnd[F, A], A, F[A]] = new NonEmptyCons[OneAnd[F, A], A, F[A]] {
