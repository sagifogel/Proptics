...
class LensSpec extends PropticsSuite {
  ...
  checkAll("Lens[Int, Int] andThen Iso[Int, Int]", LensTests(lens andThen iso).lens)
  checkAll("Lens[Int, Int] compose with Lens[Int, Int]", LensTests(lens compose lens).lens)
  checkAll("Lens[Int, Int] andThen Lens[Int, Int]", LensTests(lens andThen lens).lens)
  ...
  checkAll("Lens[Int, Int] andThen AnIso[Int, Int]", LensTests(lens andThen anIso).lens)
  checkAll("Lens[Int, Int] compose with ALens[Int, Int]", ALensTests(lens compose aLens).aLens)
  checkAll("Lens[Int, Int] andThen ALens[Int, Int]", ALensTests(lens andThen aLens).aLens)
  ...
  checkAll("Lens[Int, Int] andThen Prism[Int, Int]", AffineTraversalTests(lens andThen prism).affineTraversal)
  checkAll("Lens[Int, Int] compose with APrism[Int, Int]", AffineTraversalTests(lens compose aPrism).affineTraversal)
  checkAll("Lens[Int, Int] andThen APrism[Int, Int]", AffineTraversalTests(lens andThen aPrism).affineTraversal)
  ...
  checkAll("Lens[Int, Int] andThen AffineTraversal[Int, Int]", AffineTraversalTests(lens andThen affineTraversal).affineTraversal)
  ...
  checkAll("Lens[Int, Int] andThen AnAffineTraversal[Int, Int]", AnAffineTraversalTests(lens andThen anAffineTraversal).anAffineTraversal)
  checkAll("Lens[Int, Int] compose with Traversal[Int, Int]", TraversalTests(lens compose traversal).traversal)
  checkAll("Lens[Int, Int] andThen Traversal[Int, Int]", TraversalTests(lens andThen traversal).traversal)
  checkAll("Lens[Int, Int] compose with ATraversal[Int, Int]", ATraversalTests(lens compose aTraversal).aTraversal)
  checkAll("Lens[Int, Int] andThen ATraversal[Int, Int]", ATraversalTests(lens andThen aTraversal).aTraversal)
  checkAll("Lens[Int, Int] compose with Setter[Int, Int]", SetterTests(lens compose setter).setter)
  checkAll("Lens[Int, Int] andThen Setter[Int, Int]", SetterTests(lens andThen setter).setter)
  checkAll("Lens[Int, Int] compose with IndexedLens[Int, Int, Int]", IndexedLensTests(lens compose indexedLens).indexedLens)
  checkAll("Lens[Int, Int] andThen IndexedLens[Int, Int, Int]", IndexedLensTests(lens andThen indexedLens).indexedLens)
  checkAll("Lens[Int, Int] compose with AnIndexedLens[Int, Int, Int]", AnIndexedLensTests(lens compose anIndexedLens).anIndexedLens)
  checkAll("Lens[Int, Int] andThen AnIndexedLens[Int, Int, Int]", AnIndexedLensTests(lens andThen anIndexedLens).anIndexedLens)
  ...
  checkAll("Lens[Int, Int] andThen IndexedTraversal[Int, Int, Int]", IndexedTraversalTests(lens andThen indexedTraversal).indexedTraversal)
  checkAll("Lens[Int, Int] compose with IndexedSetter[Int, Int, Int]", IndexedSetterTests(lens compose indexedSetter).indexedSetter)
  checkAll("Lens[Int, Int] andThen IndexedSetter[Int, Int, Int]", IndexedSetterTests(lens andThen indexedSetter).indexedSetter)
