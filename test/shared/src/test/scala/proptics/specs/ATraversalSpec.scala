...
class ATraversalSpec extends PropticsSuite {
  ...
  checkAll("ATraversal apply", ATraversalRules(wholeTraversal))
  checkAll("ATraversal asTraversal", TraversalRules(wholeTraversal.asTraversal))
  checkAll("compose with Iso", ATraversalRules(aTraversal compose iso))
  checkAll("compose with AnIso", ATraversalRules(aTraversal compose anIso))
  checkAll("compose with Lens", ATraversalRules(aTraversal compose lens))
  checkAll("compose with ALens", ATraversalRules(aTraversal compose aLens))
  checkAll("compose with Prism", ATraversalRules(aTraversal compose prism))
  checkAll("compose with APrism", ATraversalRules(aTraversal compose aPrism))
  checkAll("compose with AffineTraversal", ATraversalRules(aTraversal compose affineTraversal))
  checkAll("compose with AnAffineTraversal", ATraversalRules(aTraversal compose anAffineTraversal))
  checkAll("compose with Traversal", ATraversalRules(aTraversal compose traversal))
  checkAll("compose with ATraversal", ATraversalRules(aTraversal compose aTraversal))
  checkAll("compose with Setter", SetterRules(aTraversal compose setter))
