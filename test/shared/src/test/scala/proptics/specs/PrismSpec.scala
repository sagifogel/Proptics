...
class PrismSpec extends PropticsSuite {
  ...
  checkAll("Prism[Int, Int] compose with Lens[Int, Int]", TraversalTests(prism compose lens).traversal)
  checkAll("Prism[Int, Int] compose with ALens[Int, Int]", TraversalTests(prism compose aLens).traversal)
