...
class APrismSpec extends PropticsSuite {
  ...
  checkAll("APrism[Json, String] fromOption", APrismRules(fromOptionJsonPrism))
  checkAll("APrism[Json, String] fromPartial", APrismRules(partialJsonPrism))
  checkAll("APrism[Json, String] apply", APrismRules(jsonPrism))
  checkAll("APrism[Json, String] asPrism", PrismRules(jsonPrism.asPrism))
  checkAll("APrism[Int, Int] id", PrismRules(APrism.id[Int]))
  checkAll("APrism[Int, Int] compose with Iso[Int, Int]", APrismRules(aPrism compose iso))
  checkAll("APrism[Int, Int] compose with AnIso[Int, Int]", APrismRules(aPrism compose anIso))
  checkAll("APrism[Int, Int] compose with Lens[Int, Int]", TraversalRules(aPrism compose lens))
  checkAll("APrism[Int, Int] compose with ALens[Int, Int]", TraversalRules(aPrism compose aLens))
  checkAll("APrism[Int, Int] compose with Prism[Int, Int]", APrismRules(aPrism compose prism))
  checkAll("APrism[Int, Int] compose with APrism[Int, Int]", APrismRules(aPrism compose aPrism))
  checkAll("APrism[Int, Int] compose with AffineTraversal[Int, Int]", AffineTraversalRules(aPrism compose affineTraversal))
  checkAll("APrism[Int, Int] compose with AnAffineTraversal[Int, Int]", AnAffineTraversalRules(aPrism compose anAffineTraversal))
  checkAll("APrism[Int, Int] compose with Traversal[Int, Int]", TraversalRules(aPrism compose traversal))
